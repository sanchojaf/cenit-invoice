...
export class SetupCurrentPlan extends BaseComponent {
    constructor(props) {
        super(props);
    ...
    renderWithAppContext(appContext) {
        ...
        return (
            <div className={'setup plan ' + (connected ? 'connected' : 'disconnected')}>
                <AccountConnection
                    connected={connected}
                    details={details}
                ...
                <FooterHelp>
                    {'Learn more about '}
                    {this.renderExternalLink('plans', this.state.helpUri)}
                    {' status.'}
                </FooterHelp>
            </div>
        )
